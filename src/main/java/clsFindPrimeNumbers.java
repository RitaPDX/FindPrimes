...
class clsFindPrimeNumbers
  ...
  private JLabel lblValInit;
  public JSpinner spnValInit;
  ...
  private void btnOKActionPerformed(ActionEvent e)
    ...
    if (blnIsRadSel)
      ...
      int intValInit = (Integer) spnValInit.getValue();
      final int intCat = intPrmCat;
      clsMath.doCalc(intCount, intCat, intValInit);
      }
    }
  ...
  public void initComponents()
    ...
    lblValInit = new JLabel();
    spnValInit = new JSpinner();
    ...
    //======== dlgPrimeNumbers ========
    {
      ...
      //======== dialogPane ========
      {
        dialogPane.setBorder(new LineBorder(Color.blue));
        ...
        //======== panel1 ========
        {
          ...
          //======== pnlPrimes ========
          {
            ...
            pnlPrimes.setMaximumSize(new Dimension(750, 440));
            pnlPrimes.setMinimumSize(new Dimension(750, 440));
            pnlPrimes.setPreferredSize(new Dimension(750, 440));
            ...
            //---- lblCount ----
            lblCount.setText("Enter the number of Prime Numbers you wish to find:");
            lblCount.setBackground(new Color(0, 0, 102));
            lblCount.setForeground(new Color(153, 255, 255));
            lblCount.setFont(new Font("sansserif", Font.BOLD, 14));
            pnlPrimes.add(lblCount, "cell 2 0 3 1");
            ...
            spnCount.setBorder(new LineBorder(Color.cyan));
            spnCount.setPreferredSize(new Dimension(90, 40));
            spnCount.setModel(new SpinnerNumberModel(2, 2, null, 1));
            pnlPrimes.add(spnCount, "pad 0,cell 2 0 3 1,alignx right,growx 0");

            //---- lblValInit ----
            lblValInit.setText("Enter the initial Prime Number");
            lblValInit.setBackground(new Color(0, 0, 102));
            lblValInit.setFont(new Font("sansserif", Font.BOLD, 14));
            lblValInit.setForeground(new Color(153, 255, 255));
            pnlPrimes.add(lblValInit, "cell 2 2");

            //---- spnValInit ----
            spnValInit.setMaximumSize(new Dimension(90, 40));
            spnValInit.setMinimumSize(new Dimension(90, 40));
            spnValInit.setPreferredSize(new Dimension(90, 40));
            spnValInit.setBackground(new Color(0, 0, 102));
            spnValInit.setForeground(new Color(153, 255, 255));
            spnValInit.setBorder(new LineBorder(Color.cyan));
            spnValInit.setFont(new Font(".SF NS Text", Font.BOLD, 13));
            spnValInit.setModel(new SpinnerNumberModel(2, 2, null, 1));
            pnlPrimes.add(spnValInit, "pad 0,cell 4 2,alignx right,growx 0");
            ...
            pnlPrimes.add(lblCatgry, "cell 2 4 4 1");
            ...
            pnlPrimes.add(btnHlpTwin, "cell 1 5");
            ...
            pnlPrimes.add(radTwin, "cell 2 5,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpSphy, "cell 3 5");
            ...
            pnlPrimes.add(radSophie, "cell 4 5,growx");
            ...
            pnlPrimes.add(btnHlpTrplt, "cell 1 6");
            ...
            pnlPrimes.add(radTriplet, "cell 2 6,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpCunn, "cell 3 6");
            ...
            pnlPrimes.add(radCunningham, "cell 4 6,growx");
            ...
            pnlPrimes.add(btnHlpQuad, "cell 1 7");
            ...
            pnlPrimes.add(radQuad, "cell 2 7,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpSafe, "cell 3 7");
            ...
            pnlPrimes.add(radSafe, "cell 4 7,growx");
            ...
            pnlPrimes.add(btnHlpQuint, "cell 1 8");
            ...
            pnlPrimes.add(radQuint, "cell 2 8,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpBaln, "cell 3 8");
            ...
            pnlPrimes.add(radBalanced, "cell 4 8,growx");
            ...
            pnlPrimes.add(btnHlpSext, "cell 1 9");
            ...
            pnlPrimes.add(radSext, "cell 2 9,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpReglr, "cell 3 9");
            ...
            pnlPrimes.add(radRegular, "cell 4 9,growx");
            ...
            pnlPrimes.add(btnHlpCousin, "cell 1 10");
            ...
            pnlPrimes.add(radCousin, "cell 2 10,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpArProg, "cell 3 10");
            ...
            pnlPrimes.add(radArithProg, "cell 4 10,growx");
            ...
            pnlPrimes.add(btnHlpSxy, "cell 1 11");
            ...
            pnlPrimes.add(radSexy, "cell 2 11,alignx left,growx 0");
            ...
            pnlPrimes.add(btnHlpBiTwin, "cell 3 11");
            ...
            pnlPrimes.add(radBiTwin, "cell 4 11,growx");
          }
        ...
        //======== btnBar4Primes ========
        {
          ...
          btnBar4Primes.setMaximumSize(new Dimension(750, 75));
          btnBar4Primes.setMinimumSize(new Dimension(750, 75));
